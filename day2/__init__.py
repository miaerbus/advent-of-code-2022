...
def rock_paper_scissors_part_1():
    count = 0
    total = 0
    for line in lines:
        count += 1
        total += calculate_match_part_1(line.strip().split(" "))
    return total


def calculate_match_part_1(arr):
    # print(arr[0], arr[1])
    result = 0
    if arr[0] == 'A':
        if arr[1] == 'X':
...
def rock_paper_scissors_part_2():
    ...
    for line in lines:
        count += 1
        total += calculate_match_part_2(line.strip().split(" "))
    return total


# X means you need to lose, Y means you need to end the round in a draw, and Z means you need to win
def calculate_match_part_2(arr):
    # print(arr[0], arr[1])
    result = 0
    if arr[0] == 'A':
        if arr[1] == 'X':
...
print('Rock scissor paper part 1:', rock_paper_scissors_part_1())
print('Rock scissor paper part 2:', rock_paper_scissors_part_2())
